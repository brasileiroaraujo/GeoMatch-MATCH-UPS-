...
public class GeoPolygon implements Serializable, Cloneable{
	...
	public GeoPolygon(GeoPolygon other) {
		...
		this.idGeometry = other.getIdGeometry();
		this.geoName = other.getGeoName();
		this.type = other.getType();
		this.idInDataset = other.getIdInDataset();
		this.isDuplicated = other.isDuplicated;
		this.geoBlockLabel = other.getGeoBlockLabel();
	}
	...
	public void setGeoBlockLabel(String geoBlockLabel) {
		this.geoBlockLabel = geoBlockLabel;
	}
	
	public String getGeoBlockLabel() {
		return geoBlockLabel;
	}
	...
	/**
	 * This method calculates the proportion of common area between two polygons.
	 * This value is calculated based on the Fan Work (paper: Quality assessment for building footprints data on OpenStreetMap)
	 * @param otherGeometry
	 * @return the proportion of common area between two polygons
	 */
	public double getPolygonSimilarityFanRule(GeoPolygon otherGeometry){
		Geometry intersectionGeometry = geometry.intersection(otherGeometry.getGeometry());
		
		return (intersectionGeometry.getArea())/Math.min(geometry.getArea(), otherGeometry.getGeometry().getArea());
	}
