...
public class DatabaseCSVConverter {
	//parameters: queries/bustops_pref_curitiba2.txt outputCSV/bustops_pref_curitiba4.csv
	//queries/osm_la_full.txt outputCSV/full_osm_la.csv
	public static void main(String[] args) throws IOException {
		...
		for (GenericObject dude : list) {
			...
			if (!dude.getData().get("name").toString().equalsIgnoreCase("null")) {
